...
/**
 * This is a Dagger component. Refer to {@link com.framgia.wsm.screen.notification.MainApplication}
 * for the list of Dagger components
 * used in this application.
 */
@FragmentScope
@Component(dependencies = MainComponent.class, modules = NotificationModule.class)
