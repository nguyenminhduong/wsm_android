 ...
 */
@ActivityScope
@Component(dependencies = AppComponent.class, modules = ListRequestLeaveModule.class)
public interface ListRequestLeaveComponent {
    void inject(ListRequestLeaveActivity listrequestleaveActivity);
}
